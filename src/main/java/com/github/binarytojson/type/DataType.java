...
/**
 * Enum representing various data types used in a data transformation scenario.
 * Each data type has a primary value and a list of aliases that can be used to identify it.
 */
